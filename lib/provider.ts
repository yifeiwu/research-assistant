import { DEFAULT_GROQ_MODEL, GROQ_MODELS } from "./models";
import { DEFAULT_EFFORT, type EffortLevel } from "./effort";
...
export type ProviderSettings = {
  ...
  customApiKey: string;
  customModel: string;
  /** How hard the agent should work (caps agent steps + search/crawl calls). */
  effort: EffortLevel;
};
...
/** Short label for the currently selected model, for compact UI chips. */
export function currentModelLabel(settings: ProviderSettings): string {
